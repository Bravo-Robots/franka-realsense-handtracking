...
#include "hand_interfaces/msg/detail/finger_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hand_interfaces::msg::FingerData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hand_interfaces::msg::FingerData & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hand_interfaces::msg::FingerData;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const hand_interfaces::msg::FingerData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hand_interfaces::msg::FingerData *>(
    untyped_ros_message);
...
get_message_type_support_handle<hand_interfaces::msg::FingerData>()
{
  return &hand_interfaces::msg::typesupport_fastrtps_cpp::_FingerData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hand_interfaces, msg, FingerData)() {
  return &hand_interfaces::msg::typesupport_fastrtps_cpp::_FingerData__handle;
}
